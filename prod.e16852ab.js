...
(function (a) {
  ...
  a["Control.Alternative"].Alternative = function (a, c) {
    this.Applicative0 = a;
    this.Plus1 = c;
  };
})(PS);
...
(function (a) {
  ...
  var b = a["Control.Category"],
      c = a["Control.Semigroupoid"];
  a = new function (a, b) {
    this.Semigroupoid0 = a;
    this.identity = b;
  }(function () {
    return c.semigroupoidFn;
  }, function (a) {
    return a;
  });
...
(function (a) {
  a.arrayMap = function (a) {
    return function (b) {
      for (var c = b.length, e = Array(c), d = 0; d < c; d++) {
        e[d] = a(b[d]);
      }
...
(function (a) {
  ...
  a = new e(a["Data.Functor"].arrayMap);
  b.Functor = e;
...
(function (a) {
  ...
  b.applySecond = function (a) {
    return function (b) {
      return function (d) {
        return (0, a.apply)(e.map(a.Functor0())(f["const"](c.identity(c.categoryFn)))(b))(d);
      };
    };
  };
})(PS);
...
(function (a) {
  ...
  b.liftA1 = function (a) {
    return function (b) {
      return function (f) {
        return c.apply(a.Apply0())((0, a.pure)(b))(f);
      };
    };
  };
})(PS);
...
(function (a) {
  ...
  b.ap = function (a) {
    return function (b) {
      return function (d) {
        return f.bind(a.Bind1())(b)(function (b) {
          return f.bind(a.Bind1())(d)(function (f) {
            return c.pure(a.Applicative0())(b(f));
          });
        });
      };
    };
    ...
    return function (a) {
      return function (b) {
        for (var d = a, f = !1, e; !f;) {
          e = d;
          var p = b;
          if (p instanceof c.Nil) f = !0;else {
            if (p instanceof c.Cons) d = new c.Cons(p.value0, e), b = p.value1;else throw Error("Failed pattern match at Data.List (line 368, column 3 - line 368, column 19): " + [e.constructor.name, p.constructor.name]);
            e = void 0;
          }
        }
...
(function (a) {
  a.showStringImpl = function (a) {
    var b = a.length;
    return '"' + a.replace(/[\0-\x1F\x7F"\\]/g, function (c, e) {
      switch (c) {
        case '"':
        case "\\":
          return "\\" + c;
      ...
      e += 1;
      e = e < b && "0" <= a[e] && "9" >= a[e] ? "\\&" : "";
      return "\\" + c.charCodeAt(0).toString(10) + e;
    }) + '"';
  };
...
(function (a) {
  ...
  a = new c(a["Data.Show"].showStringImpl);
  b.Show = c;
...
(function (a) {
  ...
  var b = a["Data.Maybe"],
    ...
    return function (b) {
      return function (c) {
        if (c instanceof e) return a;
        if (c instanceof d) return b(c.value0);
  ...
  b.fromMaybe = function (a) {
    return g(a)(c.identity(c.categoryFn));
  };

  b.showMaybe = function (a) {
    return new f.Show(function (b) {
      if (b instanceof d) return "(Just " + (f.show(a)(b.value0) + ")");
      if (b instanceof e) return "Nothing";
...
(function (a) {
  ...
  a = new g(f.Nil.value, f.Nil.value);
  b.empty = a;

  b["null"] = function (a) {
    return a.value0 instanceof f.Nil && a.value1 instanceof f.Nil ? !0 : !1;
  };

  b.snoc = function (a) {
    return function (b) {
      return new g(a.value0, new f.Cons(b, a.value1));
    };
  };

  b.uncons = function (a) {
    for (var b = !1, h; !b;) {
      if (h = a, h.value0 instanceof f.Nil && h.value1 instanceof f.Nil) b = !0, h = e.Nothing.value;else if (h.value0 instanceof f.Nil) a = new g(c.reverse(h.value1), f.Nil.value), h = void 0;else if (h.value0 instanceof f.Cons) b = !0, h = new e.Just(new d.Tuple(h.value0.value0, new g(h.value0.value1, h.value1)));else throw Error("Failed pattern match at Data.CatQueue (line 83, column 1 - line 83, column 63): " + [h.constructor.name]);
    }
...
(function (a) {
  ...
  a = new c(a["Data.Semigroup"].concatArray);
  b.Semigroup = c;
...
(function (a) {
  ...
  var b = a["Data.CatList"],
    ...
    return a;
      ...
      h = function h(a) {
    return function (b) {
      if (a instanceof l) return b;
      if (b instanceof l) return a;
      if (a instanceof p) return new p(a.value0, c.snoc(a.value1)(b));
    ...
    return function (b) {
      return function (d) {
        var h = function h(a) {
          return function (b) {
            return function (c) {
              for (var d = a, h = b, e = !1, m; !e;) {
                m = d;
                var k = h,
                    g = c;
                if (g instanceof f.Nil) e = !0, m = k;else {
                  if (g instanceof f.Cons) d = m, h = m(k)(g.value0), c = g.value1;else throw Error("Failed pattern match at Data.CatList (line 125, column 3 - line 125, column 59): " + [m.constructor.name, k.constructor.name, g.constructor.name]);
                  m = void 0;
                }
              }
        ...
        return function (d) {
          return function (m) {
            function k(d, k) {
              d = c.uncons(d);
              if (d instanceof e.Nothing) return q = !0, h(function (a) {
                return function (b) {
                  return b(a);
                };
              })(b)(k);
              if (d instanceof e.Just) g = d.value0.value1, m = new f.Cons(a(d.value0.value0), k);else throw Error("Failed pattern match at Data.CatList (line 121, column 14 - line 123, column 67): " + [d.constructor.name]);
            }
  ...
  b.snoc = function (a) {
    return function (b) {
      return h(a)(new p(b, c.empty));
    };
  };

  b.uncons = function (a) {
    if (a instanceof l) return e.Nothing.value;

    if (a instanceof p) {
      var b = e.Just,
          d = g.Tuple,
          f = a.value0;
      a = c["null"](a.value1) ? l.value : m(h)(l.value)(a.value1);
      return new b(new d(f, a));
    }

    throw Error("Failed pattern match at Data.CatList (line 100, column 1 - line 100, column 61): " + [a.constructor.name]);
  };

  b.semigroupCatList = d;
})(PS);
...
(function (a) {
  ...
  var b = a["Data.Either"],
    ...
    return a;
      ...
      l = new e.Functor(function (a) {
    return function (b) {
      if (b instanceof d) return new d(b.value0);
      if (b instanceof g) return new g(a(b.value0));
      throw Error("Failed pattern match at Data.Either (line 38, column 1 - line 38, column 52): " + [b.constructor.name]);
    };
  }),
      p = new f.Apply(function () {
    return l;
  }, function (a) {
    return function (b) {
      if (a instanceof d) return new d(a.value0);
      if (a instanceof g) return e.map(l)(a.value0)(b);
      throw Error("Failed pattern match at Data.Either (line 82, column 1 - line 84, column 30): " + [a.constructor.name, b.constructor.name]);
    };
  });

  a = new c.Applicative(function () {
    return p;
  }, g.create);
  b.Left = d;
  b.Right = g;
  ...
  b.either = function (a) {
    return function (b) {
      return function (c) {
        if (c instanceof d) return a(c.value0);
        if (c instanceof g) return b(c.value0);
        throw Error("Failed pattern match at Data.Either (line 238, column 1 - line 238, column 64): " + [a.constructor.name, b.constructor.name, c.constructor.name]);
      };
    };
  };

  b.functorEither = l;
  b.applicativeEither = a;
})(PS);
...
(function (a) {
  ...
  var b = a["Control.Monad.Free"],
    ...
    function b(b) {
      var d = function d(a) {
        return function (b) {
          return new t(a.value0, m.append(g.semigroupCatList)(a.value1)(b));
        };
      };

      if (b.value0 instanceof k) {
        var e = g.uncons(b.value1);
        if (e instanceof h.Nothing) return c = !0, new k(b.value0.value0);

        if (e instanceof h.Just) {
      ...
      if (b.value0 instanceof n) return c = !0, new n(b.value0.value0, function (a) {
    ...
    return function (b) {
      return function (c) {
        c = u(c);
        if (c instanceof k) return b(c.value0);
        if (c instanceof n) return a(c.value0)(c.value1);
        throw Error("Failed pattern match at Control.Monad.Free (line 213, column 17 - line 215, column 20): " + [c.constructor.name]);
      };
    };
  };

  a = new d.Monad(function () {
    return r;
  }, function () {
    return B;
  });
  var v = new p.Functor(function (a) {
    return function (b) {
      return e.bindFlipped(B)(function () {
        var b = c.pure(r);
        return function (c) {
          return b(a(c));
        };
    ...
    return function (b) {
      return new t(a.value0, g.snoc(a.value1)(b));
    };
  }),
      F = new f.Apply(function () {
    return v;
  }, d.ap(a)),
      r = new c.Applicative(function () {
    return F;
  }, function (a) {
    return new t(k.create(a), g.empty);
  });

  b.wrap = function (a) {
    return new t(new n(a, q.unsafeCoerce), g.empty);
  };

  b.liftF = function (a) {
    return new t(new n(a, function () {
      var a = c.pure(r);
      return function (b) {
        return a(b);
      };
...
(function (a) {
  ...
  a.MultiAlternative = function (a, c) {
    this.Plus0 = a;
    this.orr = c;
  };
})(PS);
...
(function (a) {
  ...
  var b = a["Data.Array"],
      c = a["Data.Array"];
  a = a["Data.Maybe"];
  a = c._updateAt(a.Just.create)(a.Nothing.value);
  b.updateAt = a;
  b.length = c.length;
})(PS);
...
(function (a) {
  ...
  b.fromArray = function (a) {
    if (0 < c.length(a)) return new e.Just(g(a));
...
(function (a) {
  a.fold1Impl = function (a) {
    return function (b) {
      for (var c = b[0], e = b.length, d = 1; d < e; d++) {
        c = a(c)(b[d]);
      }
...
(function (a) {
  a.foldrArray = function (a) {
    return function (b) {
      return function (c) {
        for (var e = b, d = c.length - 1; 0 <= d; d--) {
          e = a(c[d])(e);
        }
  ...
  a.foldlArray = function (a) {
    return function (b) {
      return function (c) {
        for (var e = b, d = c.length, f = 0; f < d; f++) {
          e = a(e)(c[f]);
        }
    ...
    return function (b) {
      return function (c) {
        return (0, a.foldr)(function (a) {
          return function (d) {
            return g.append(b.Semigroup0())(c(a))(d);
          };
        })(d.mempty(b));
      };
    };
  },
      h = new function (a, b, c) {
    this.foldMap = a;
    this.foldl = b;
    this.foldr = c;
  }(function (a) {
    return p(h)(a);
  }, c.foldlArray, c.foldrArray);
...
(function (a) {
  ...
  var b = a["Data.FoldableWithIndex"],
    ...
    return function (b) {
      return function (c) {
        return (0, a.foldrWithIndex)(function (a) {
          return function (e) {
            return function (h) {
              return d.append(b.Semigroup0())(c(a)(e))(h);
            };
          };
        })(e.mempty(b));
      };
      ...
      p = new function (a, b, c, d) {
    this.Foldable0 = a;
    this.foldMapWithIndex = b;
    this.foldlWithIndex = c;
    this.foldrWithIndex = d;
  }(function () {
    return c.foldableArray;
  }, function (a) {
    return l(p)(a);
  }, function (a) {
    return function (b) {
      var d = c.foldl(c.foldableArray)(function (b) {
        return function (c) {
          return a(c.value0)(b)(c.value1);
        };
      })(b),
          e = f.mapWithIndex(f.functorWithIndexArray)(g.create);
      return function (a) {
        return d(e(a));
      };
    };
    ...
    return function (b) {
      var d = c.foldr(c.foldableArray)(function (b) {
        return function (c) {
            ...
            return function (h) {
              function m(l, t) {
                switch (t - l) {
                  ...
                  case 2:
                    return b(d(c)(p(h[l])))(p(h[l + 1]));

                  case 3:
                    return b(b(d(f)(p(h[l])))(p(h[l + 1])))(p(h[l + 2]));

                  default:
                    var k = l + 2 * Math.floor((t - l) / 4);
                    return b(d(e)(m(l, k)))(m(k, t));
                }
              }
...
(function (a) {
  ...
  var b = a["Data.Traversable"],
      ...
      p = function p(a) {
    return function (b) {
      return (0, a.traverse)(b)(d.identity(d.categoryFn));
    };
  },
    ...
    return g.foldableArray;
  }, function () {
    return l.functorArray;
  }, function (a) {
    return p(h)(a);
  }, function (a) {
    return c.traverseArrayImpl(e.apply(a.Apply0()))(l.map(a.Apply0().Functor0()))(f.pure(a));
  });
...
(function (a) {
  ...
  var b = a["Data.Array.NonEmpty.Internal"],
      ...
      d = a["Data.Traversable"].traversableArray,
      g = a["Data.Functor"].functorArray,
      l = a["Data.FoldableWithIndex"].foldableWithIndexArray,
      p = a["Data.Foldable"].foldableArray,
      h = new e.Foldable1(function () {
    return p;
  }, function (a) {
    return c.fold1Impl(f.append(a));
  }, function (a) {
    return e.foldMap1Default(h)(g)(a);
  });
  b.functorNonEmptyArray = g;
  b.foldableWithIndexNonEmptyArray = l;
  b.foldable1NonEmptyArray = h;
  b.traversableNonEmptyArray = d;
})(PS);
...
(function (a) {
  ...
  var b = a.Effect,
      ...
      g = a["Control.Monad"];
  a = a["Data.Functor"];
  var l = new g.Monad(function () {
    return m;
  }, function () {
    return p;
  }),
      p = new d.Bind(function () {
    return h;
  }, c.bindE),
      h = new e.Apply(function () {
    return q;
  }, g.ap(l)),
      m = new f.Applicative(function () {
    return h;
  }, c.pureE),
      q = new a.Functor(f.liftA1(m));
  b.functorEffect = q;
...
(function (a) {
  var b = function () {
    ...
    function p(b, c, e) {
        ...
        for (var f, x, v;;) {
          switch (v = x = f = null, n) {
            case 2:
              n = 1;
              r = w(r);
              null === z ? w = null : (w = z._1, z = z._2);
              break;

            case 3:
              b.isLeft(r) ? (n = 5, q = r, r = null) : null === w ? n = 5 : (n = 2, r = b.fromRight(r));
              break;
            ...
            case 1:
              switch (r.tag) {
                ...
                case "Pure":
                  null === w ? (n = 5, r = b.right(r._1)) : (n = 2, r = r._1);
                  break;

                case "Sync":
                  n = 3;
                  r = g(b.left, b.right, r._1);
                  break;

                case "Async":
                  n = 4;
                  r = l(b.left, r._1, function (a) {
                    return function () {
                      k === e && (k++, t.enqueue(function () {
                        k === e + 1 && (n = 3, r = a, h(k));
                      }));
                    };
                  });
                ...
                case "Catch":
                  y = null === w ? new a("Cons", r, y, u) : new a("Cons", r, new a("Cons", new a("Resume", w, z), y, u), u);
                  z = w = null;
                  n = 1;
                  r = r._1;
                  break;
            ...
            case 5:
              z = w = null;
              if (null === y) n = 6, r = u || q || r;else switch (f = y._3, v = y._1, y = y._2, v.tag) {
                case "Catch":
                  u && u !== f && 0 === A ? n = 5 : q && (n = 1, r = v._2(b.fromLeft(q)), q = null);
                  break;

                case "Resume":
                  u && u !== f && 0 === A || q ? n = 5 : (w = v._1, z = v._2, n = 2, r = b.fromRight(r));
                  break;

                case "Bracket":
                  A--;
                  null === q && (x = b.fromRight(r), y = new a("Cons", new a("Release", v._2, x), y, f), u === f || 0 < A) && (n = 1, r = v._3(x));
                  break;

                case "Release":
                  y = new a("Cons", new a("Finalized", r, q), y, u);
                  n = 1;
                  r = u && u !== f && 0 === A ? v._1.killed(b.fromLeft(u))(v._2) : q ? v._1.failed(b.fromLeft(q))(v._2) : v._1.completed(b.fromRight(r))(v._2);
                  q = null;
                  A++;
                  break;
            ...
            case 6:
              for (var G in C) {
                C.hasOwnProperty(G) && (E = E && C[G].rethrow, d(C[G].handler(r)));
              }

              C = null;
              u && q ? setTimeout(function () {
                throw b.fromLeft(q);
              }, 0) : b.isLeft(r) && E && setTimeout(function () {
                if (E) throw b.fromLeft(r);
              }, 0);
              return;
      ...
      function f(a) {
        return function () {
          if (6 === n) return E = E && a.rethrow, a.handler(r)(), function () {};
          var b = H++;
          C = C || {};
          C[b] = a;
          return function () {
      ...
      return {
        kill: function kill(c, d) {
          return function () {
            if (6 === n) return d(b.right(void 0))(), function () {};
            var e = f({
              rethrow: !1,
            ...
            switch (n) {
              ...
              case 4:
                null === u && (u = b.left(c));
                0 === A && (4 === n && (y = new a("Cons", new a("Finalizer", r(c)), y, u)), n = 5, q = r = null, h(++k));
                break;

              default:
                null === u && (u = b.left(c)), 0 === A && (n = 5, q = r = null);
            }
        ...
        run: function run() {
          0 === n && (t.isDraining() ? h(k) : t.enqueue(function () {
            h(k);
          }));
        }
      };
    ...
    function h(b, c, d, h) {
      function f(c, d, e) {
        ...
        a: for (;;) {
          ...
          switch (h.tag) {
            case "Forked":
              h._3 === q && (k = l[h._1], d[m++] = k.kill(c, function (a) {
                return function () {
                  m--;
                  0 === m && e(a)();
                };
            ...
            case "Apply":
            case "Alt":
              f && (g = new a("Cons", f, g)), f = h, h = h._1;
          }
        }

        if (0 === m) e(b.right(void 0))();else for (c = 0, k = m; c < k; c++) {
          d[c] = d[c]();
        }
        return d;
      }
      ...
      function g(a, c, d) {
        ...
        for (;;) {
          ...
          switch (c.tag) {
            case "Map":
              null === k ? (c._3 = b.right(c._1(b.fromRight(n))), n = c._3) : c._3 = k;
              break;
            ...
            case "Apply":
              ...
              if (k) {
                if (c._3 = k, m = !0, l = u++, t[l] = f(x, k === a ? c._2 : c._1, function () {
                  return function () {
                    delete t[l];
                    m ? m = !1 : null === d ? g(k, null, null) : g(k, d._1, d._2);
                  };
                }), m) {
                  m = !1;
                  return;
                ...
                if (a === q || e === q) return;
                n = b.right(b.fromRight(a)(b.fromRight(e)));
                c._3 = n;
              }
            ...
            case "Alt":
              a = c._1._3;
              e = c._2._3;
              if (a === q && b.isLeft(e) || e === q && b.isLeft(a)) return;
              if (a !== q && b.isLeft(a) && e !== q && b.isLeft(e)) k = n === a ? e : a, n = null, c._3 = k;else if (c._3 = n, m = !0, l = u++, t[l] = f(x, n === a ? c._2 : c._1, function () {
                return function () {
                  delete t[l];
                  m ? m = !1 : null === d ? g(n, null, null) : g(n, d._1, d._2);
                };
              }), m) {
                m = !1;
                return;
          ...
          switch (e) {
            case 1:
              switch (h.tag) {
                case "Map":
                  f && (g = new a("Cons", f, g));
                  f = new a("Map", h._1, q, q);
                  h = h._2;
                  break;

                case "Apply":
                  f && (g = new a("Cons", f, g));
                  f = new a("Apply", q, h._2, q);
                  h = h._1;
                  break;

                case "Alt":
                  f && (g = new a("Cons", f, g));
                  f = new a("Alt", q, h._2, q);
                  h = h._1;
                  break;
                ...
                default:
                  ...
                  e = 5;
                  var t = h;
                  h = new a("Forked", k, new a("Cons", f, g), q);
                  t = p(b, c, t);
                  t.onComplete({
                    rethrow: !1,
                    handler: m(h)
            ...
            case 5:
              if (null === f) break a;
              f._1 === q ? (f._1 = h, e = 1, h = f._2, f._2 = q) : (f._2 = h, h = f, null === g ? f = null : (f = g._1, g = g._2));
          }
        }
    ...
    a.Supervisor = function (b) {
      ...
      return {
        ...
        killAll: function killAll(h, f) {
          return function () {
            function g(a) {
              k[a] = c[a].kill(h, function (c) {
                return function () {
                  delete k[a];
                  m--;
  ...
  a._map = function (a) {
    return function (c) {
      return c.tag === b.Pure.tag ? b.Pure(a(c._1)) : b.Bind(c, function (c) {
        return b.Pure(a(c));
      });
    };
  };
  ...
  a._makeFiber = function (a, f) {
    return function () {
      return b.Fiber(a, null, f);
    };
  };
...
(function (a) {
  ...
  b["try"] = function (a) {
    return function (b) {
      return (0, a.catchError)(e.map(a.MonadThrow0().Monad0().Bind1().Apply0().Functor0())(f.Right.create)(b))(function () {
        var b = c.pure(a.MonadThrow0().Monad0().Applicative0());
        return function (a) {
          return b(f.Left.create(a));
        };
      }());
    };
  };
...
(function (a) {
  ...
  var b = a["Control.Category"],
      c = a["Control.Parallel.Class"],
      f = a["Data.Foldable"],
      e = function e(a) {
    return function (b) {
      return function (d) {
        var e = c.sequential(a),
            h = f.traverse_(a.Applicative1())(b)(function () {
          var b = c.parallel(a);
          return function (a) {
            return b(d(a));
          };
  ...
  a["Control.Parallel"].parSequence_ = function (a) {
    return function (c) {
      return e(a)(c)(b.identity(b.categoryFn));
    };
  };
})(PS);
...
(function (a) {
  ...
  a.liftEffect = function (a) {
    return a.liftEffect;
  };

  a.MonadEffect = function (a, c) {
    this.Monad0 = a;
    this.liftEffect = c;
  };
})(PS);
...
(function (a) {
  ...
  a = new a["Data.Show"].Show(c.showErrorImpl);
  b.showError = a;
  b.error = c.error;
})(PS);
...
(function (a) {
  ...
  var w = new u.Functor(c._parAffMap),
      z = new u.Functor(c._map),
      y = function () {
    return {
      ...
      fromLeft: function fromLeft(a) {
        ...
        if (a instanceof t.Right) return D.unsafeCrashWith("unsafeFromLeft: Right");
      ...
      fromRight: function fromRight(a) {
        ...
        if (a instanceof t.Left) return D.unsafeCrashWith("unsafeFromRight: Left");
      ...
      A = function A(a) {
    return function () {
      var b = c._makeFiber(y, a)();

      b.run();
      return b;
    };
  },
      H = new d.Apply(function () {
    return w;
  }, c._parAffApply),
      C = new l.Monad(function () {
    return J;
  }, function () {
    return E;
  }),
    ...
    return G;
      ...
      G = new d.Apply(function () {
    return z;
  }, l.ap(C)),
      J = new e.Applicative(function () {
    return G;
  }, c._pure),
      K = new r.MonadEffect(function () {
    return C;
  }, c._liftEffect);

  d = function () {
    var a = r.liftEffect(K);
    return function (b) {
      return n["const"](a(b));
    };
  }();

  var N = new p.MonadThrow(function () {
    return C;
  }, c._throwError),
      L = new p.MonadError(function () {
    return N;
  }, c._catchError),
      O = function O(a) {
    return function (b) {
      return A(g.bindFlipped(E)(function () {
        var b = r.liftEffect(K);
        return function (c) {
          return b(a(c));
        };
      }())(p["try"](L)(b)));
    ...
    return C;
  }, a.unsafeCoerce, c._sequential),
      Q = new e.Applicative(function () {
    return H;
  }, function () {
    var a = m.parallel(M),
        b = e.pure(J);
    return function (c) {
      ...
      R = new v.Semigroup(function (a) {
    return function (b) {
      return function (c) {
        return h.parSequence_(M)(k.foldableArray)([a(c), b(c)]);
      };
    };
  });

  v = n["const"](e.pure(J)(B.unit));
  var S = new x.Monoid(function () {
    return R;
  }, v);
  v = c.makeAff(function (a) {
    return e.pure(F.applicativeEffect)(x.mempty(S));
  });
  var P = new f.Alt(function () {
    return w;
  }, c._parAffAlt),
      T = new f.Alt(function () {
    return z;
  }, function (a) {
    return function (b) {
      return p.catchError(L)(a)(n["const"](b));
    };
  });
  f = new q.Plus(function () {
    return T;
  }, p.throwError(N)(I.error("Always fails")));
  q = new q.Plus(function () {
    return P;
  }, m.parallel(M)(q.empty(f)));

  b.runAff_ = function (a) {
    return function (b) {
      return u["void"](F.functorEffect)(O(a)(b));
    };
  };
...
(function (a) {
  ...
  var b = a["Concur.Core.Types"],
      c = a["Control.Alt"],
      f = a["Control.Alternative"],
      e = a["Control.Applicative"],
      d = a["Control.Bind"],
      g = a["Control.Category"],
      l = a["Control.Monad.Free"],
      p = a["Control.MultiAlternative"],
      h = a["Control.Parallel.Class"],
      m = a["Control.Plus"],
  ...
  a = new a["Control.ShiftMap"].ShiftMap(function (a) {
    return a(g.identity(g.categoryFn));
  });
  ...
  var z = l.freeFunctor,
    ...
    return l["resume'"](function (b) {
      return function (c) {
        return new k.Right(u.map(a)(c)(b));
      };
    })(k.Left.create);
  },
      G = new u.Functor(function (a) {
    return function (b) {
      return u.map(D.functorEffect)(function (b) {
        if (b instanceof k.Right) return new k.Right({
          cont: u.map(w.functorAff)(a)(b.value0.cont),
          view: b.value0.view
        });
        if (b instanceof k.Left) return new k.Left(a(b.value0));
        throw Error("Failed pattern match at Concur.Core.Types (line 45, column 5 - line 46, column 34): " + [b.constructor.name]);
      })(b);
    };
  }),
      J = function J(a) {
    return e.pure(D.applicativeEffect)(new k.Right({
      view: a,
      cont: w.never
    }));
  },
    ...
    return l.liftF(J(a));
      ...
      N = function N(a) {
    return new B.Semigroup(function (b) {
      return function (c) {
        return p.orr(O(a))([b, c]);
      };
    });
  },
      L = function L(a) {
    return new m.Plus(function () {
      return M(a);
    }, K(v.mempty(a)));
  },
      O = function O(a) {
    return new p.MultiAlternative(function () {
      return L(a);
    }, function (b) {
      var f = function f(a) {
        return k.either(function (b) {
          b = E(G)(b);
          if (b instanceof k.Left) return e.pure(D.applicativeEffect)(new k.Left(b.value0));
          if (b instanceof k.Right) return d.bind(D.bindEffect)(b.value0)(f(a));
          throw Error("Failed pattern match at Concur.Core.Types (line 127, column 26 - line 129, column 57): " + [b.constructor.name]);
        })(function (a) {
          return e.pure(D.applicativeEffect)(new k.Right(a));
        });
      },
          g = function g(a) {
        return function (b) {
          return function (f) {
            var g = u.map(t.functorNonEmptyArray)(function () {
              var a = e.pure(D.applicativeEffect);
              return function (b) {
                return l.wrap(a(k.Right.create(b)));
              };
            }())(b);
            return d.bind(w.bindAff)(h.sequential(w.parallelAff)(n.foldlWithIndex(t.foldableWithIndexNonEmptyArray)(function (a) {
              return function (b) {
                return function (d) {
                  return c.alt(w.altParAff)(h.parallel(w.parallelAff)(u.map(w.functorAff)(I.Tuple.create(a))(d)))(b);
                };
              };
            })(m.empty(w.plusParAff))(f)))(function (b) {
              return e.pure(w.applicativeAff)(p(a)(x.fromMaybe(g)(q.updateAt(b.value0)(b.value1)(g))));
            });
          };
        };
      },
          p = function p(a) {
        return function (b) {
          var c = r.traverse(t.traversableNonEmptyArray)(k.applicativeEither)(E(G))(b);
          if (c instanceof k.Left) return e.pure(l.freeApplicative)(c.value0);
          if (c instanceof k.Right) return l.wrap(function () {
            var b = r.traverse(t.traversableNonEmptyArray)(D.applicativeEffect)(H)(c.value0)();
            b = r.traverse(t.traversableNonEmptyArray)(D.applicativeEffect)(f(a))(b)();
            b = r.sequence(t.traversableNonEmptyArray)(k.applicativeEither)(b);
            if (b instanceof k.Left) return new k.Left(e.pure(l.freeApplicative)(b.value0));
            if (b instanceof k.Right) return new k.Right({
              view: F.foldMap1(t.foldable1NonEmptyArray)(a.Semigroup0())(function (a) {
                return a.view;
              })(b.value0),
              cont: g(a)(b.value0)(u.map(t.functorNonEmptyArray)(function (a) {
                return a.cont;
              })(b.value0))
            });
      ...
      b = q.fromArray(b);
      if (b instanceof x.Just) return p(a)(u.map(t.functorNonEmptyArray)(C)(b.value0));
      if (b instanceof x.Nothing) return m.empty(L(a));
      throw Error("Failed pattern match at Concur.Core.Types (line 90, column 13 - line 92, column 21): " + [b.constructor.name]);
    });
  },
      M = function M(a) {
    return new c.Alt(function () {
      return z;
    }, B.append(N(a)));
  };
  ...
  b.resume = E;
  b.display = K;
  b.functorWidgetStep = G;
  b.widgetFunctor = z;
  b.widgetBind = y;
  b.widgetApplicative = A;
  b.widgetShiftMap = a;
  b.widgetMultiAlternative = O;

  b.widgetAlternative = function (a) {
    return new f.Alternative(function () {
      return A;
    }, function () {
      return L(a);
    });
...
(function (a) {
  var b = function () {
    ...
    e.deleteCell = function (a) {
      null !== a.queue && (a.queue.last === a ? g(a.queue) : a.queue.head === a ? l(a.queue) : (a.prev && (a.prev.next = a.next), a.next && (a.next.prev = a.prev), a.queue.size--, a.queue = null, a.value = null, a.next = null, a.prev = null));
    };

    e.drainVar = function (a, b) {
      if (!b.draining) {
        var c = b.puts,
            e = b.takes,
            f = b.reads,
        ...
        for (b.draining = !0;;) {
          ...
          if (v !== p) {
            ...
            null !== g && (b.value = p, d(g(a.right(v))));
          }

          null !== h && d(h.cb(a.right(void 0)));
          if (b.value === p && 0 === c.size || b.value !== p && 0 === e.size) break;
        }
  ...
  a._takeVar = function (a, f, e) {
    return function () {
      var c = b.putLast(f.takes, e);
      b.drainVar(a, f);
      return function () {
        b.deleteCell(c);
      };
  ...
  a._tryPutVar = function (a, f, e) {
    return function () {
      return e.value === b.EMPTY && null === e.error ? (e.value = f, b.drainVar(a, e), !0) : !1;
    };
  };
...
(function (a) {
  ...
  b.take = function (a) {
    return function (b) {
      return c._takeVar(l, a, b);
    };
  };

  b.tryPut = function (a) {
    return function (b) {
      return c._tryPutVar(l, a, b);
    };
  };
...
(function (a) {
  ...
  a["Effect.Aff.AVar"].take = function (a) {
    return c.makeAff(function (e) {
      return function () {
        var d = b.take(a)(e)();
        return c.effectCanceler(d);
      };
    });
  };
})(PS);
...
(function (a) {
  ...
  var b = a["Concur.Core"],
      ...
      f = a["Control.Alt"],
      e = a["Control.Applicative"],
      d = a["Control.Monad.Free"],
      g = a["Control.Parallel.Class"],
      l = a["Data.Either"],
      p = a["Data.Functor"],
      h = a.Effect,
      m = a["Effect.AVar"],
      q = a["Effect.Aff"],
      t = a["Effect.Aff.AVar"],
      k = a["Effect.Aff.Class"],
      n = function n(a) {
    return function (b) {
      var u = c.resume(c.functorWidgetStep)(b);
      if (u instanceof l.Left) return e.pure(d.freeApplicative)(u.value0);
      if (u instanceof l.Right) return d.wrap(function () {
        var b = u.value0();
        if (b instanceof l.Left) return new l.Left(b.value0);

        if (b instanceof l.Right) {
          var c = m.empty(),
              r = g.sequential(q.parallelAff)(f.alt(q.altParAff)(g.parallel(q.parallelAff)(k.liftAff(k.monadAffAff)(t.take(c))))(g.parallel(q.parallelAff)(p.map(q.functorAff)(n(a))(b.value0.cont))));
          return new l.Right({
            view: a(function (a) {
              return p["void"](h.functorEffect)(m.tryPut(e.pure(d.freeApplicative)(a))(c));
            })(b.value0.view),
            cont: r
          });
        }
      ...
      throw Error("Failed pattern match at Concur.Core (line 50, column 27 - line 64, column 23): " + [u.constructor.name]);
    };
  };

  b.mkLeafWidget = function (a) {
    return c.Widget(d.wrap(function () {
      var b = m.empty(),
          c = a(function (a) {
        return p["void"](h.functorEffect)(m.tryPut(e.pure(d.freeApplicative)(a))(b));
      }),
          f = k.liftAff(k.monadAffAff)(t.take(b));
      return new l.Right({
        view: c,
        cont: f
      });
...
(function (a) {
  ...
  a = new a.Functor(function (a) {
    return function (b) {
      if (b instanceof c) return new c(b.value0);
      if (b instanceof f) return new f(function (c) {
  ...
  b.mkProp = function (a) {
    return function (b) {
      if (b instanceof c) return b.value0;
      if (b instanceof f) return b.value0(a);
...
(function (a) {
  ...
  var b = a["Concur.Core.DOM"],
      ...
      d = a["Control.MultiAlternative"],
      g = a["Control.ShiftMap"],
      l = a["Data.Functor"],
      p = function p(a) {
    return function (b) {
      return function (d) {
        return function (f) {
          return g.shiftMap(a)(function (a) {
            return function (g) {
              return c.wrapViewEvent(function (c) {
                return function (g) {
                  return d(l.map(b)(function () {
                    var b = e.mkProp(c),
                        d = l.map(e.functorProps)(a);
                    return function (a) {
                      return b(d(a));
                    };
                  }())(f))(g);
  ...
  b.elLeaf = function (a) {
    return function (b) {
      return function (d) {
        return function (g) {
          return f.liftWidget(a)(c.mkLeafWidget(function (a) {
            return d(l.map(b)(e.mkProp(a))(g));
          }));
        };
      };
    };
...
(function (a) {
  ...
  var b = a["Concur.Core.Discharge"],
      ...
      q = function q(a) {
    return function (b) {
      var g = e.resume(c.functorWidgetStep)(c.unWidget(b));
      if (g instanceof d.Right) return f.pure(h.applicativeEffect)(new p.Tuple(b, l.mempty(a)));
      if (g instanceof d.Left) return function () {
        var b = g.value0();
        if (b instanceof d.Left) return q(a)(b.value0)();
        if (b instanceof d.Right) return new p.Tuple(e.wrap(f.pure(h.applicativeEffect)(new d.Right(b.value0))), b.value0.view);
        throw Error("Failed pattern match at Concur.Core.Discharge (line 49, column 5 - line 51, column 86): " + [b.constructor.name]);
      };
      throw Error("Failed pattern match at Concur.Core.Discharge (line 45, column 28 - line 51, column 86): " + [g.constructor.name]);
    };
  },
      t = function t(a) {
    return function (b) {
      return function (k) {
        var p = e.resume(c.functorWidgetStep)(k);
        if (p instanceof d.Right) return f.pure(h.applicativeEffect)(l.mempty(a));
        if (p instanceof d.Left) return function () {
          var e = p.value0();
          if (e instanceof d.Left) return t(a)(b)(e.value0)();
          if (e instanceof d.Right) return m.runAff_(function () {
            var a = g.map(d.functorEither)(c.Widget);
            return function (c) {
              return b(a(c));
            };
          }())(e.value0.cont)(), e.value0.view;
          throw Error("Failed pattern match at Concur.Core.Discharge (line 32, column 5 - line 36, column 21): " + [e.constructor.name]);
        };
        throw Error("Failed pattern match at Concur.Core.Discharge (line 28, column 32 - line 36, column 21): " + [p.constructor.name]);
      };
    };
  };

  b.discharge = t;
  b.dischargePartialEffect = q;
})(PS);
...
(function (a) {
  ...
  a["Control.Extend"].Extend = function (a, c) {
    this.Functor0 = a;
    this.extend = c;
  };
})(PS);
...
(function (a) {
  ...
  var b = a["Control.Cofree"],
      ...
      n = a["Data.Tuple"],
      u = function u(a) {
    return n.snd(k.force(a));
  },
      x = function x(a) {
    return function (b) {
      return k.defer(function (c) {
        return new n.Tuple(a, b);
      });
    };
  },
      v = function v(a) {
    return n.fst(k.force(a));
  },
      B = function B(a) {
    return new t.Functor(function (b) {
      var c = function c(d) {
        return t.map(k.functorLazy)(function (d) {
          return new n.Tuple(b(d.value0), t.map(a)(c)(d.value1));
        })(d);
      };
    ...
    return new p.Extend(function () {
      ...
      var c = function c(d) {
        return t.map(k.functorLazy)(function (e) {
          return new n.Tuple(b(d), t.map(a)(c)(e.value1));
        })(d);
      };
    ...
    return new g.Bind(function () {
      ...
      return function (c) {
        var d = function d(b) {
          return function (c) {
            var g = t.map(a.Plus1().Alt0().Functor0())(d(b))(u(c)),
                h = t.map(a.Plus1().Alt0().Functor0())(e)(u(b));
            return x(v(c))(f.alt(a.Plus1().Alt0())(h)(g));
          };
        },
            e = function e(a) {
          return d(a)(c(v(a)));
      ...
      D = function D(a) {
    return new d.Apply(function () {
      return B(a.Plus1().Alt0().Functor0());
    }, h.ap(r(a)));
  },
      w = function w(a) {
  ...
  b.applicativeCofree = w;
  b.bindCofree = I;

  b.shiftMapCofree = function (a) {
    return new q.ShiftMap(function (b) {
      return function (d) {
        return k.defer(function (f) {
          f = k.force(d);
          return new n.Tuple(f.value0, b(e.pure(w(c.widgetAlternative(a))))(f.value1));
        });
      };
    });
  };
...
(function (a) {
  ...
  var b = a["Concur.Core.FRP"],
    ...
    return function (b) {
      return function (k) {
        var l = k(b);
        return h(g.extract(d.comonadCofree(c.widgetFunctor))(l))(e.bind(c.widgetBind)(p(l))(function (b) {
          return f.pure(c.widgetApplicative)(m(a)(g.extract(d.comonadCofree(c.widgetFunctor))(b))(k));
        }));
      };
    };
  },
      q = function q(a) {
    return e.bind(c.widgetBind)(p(a))(q);
  };
...
(function (a) {
  function b(a) {
    return function (b) {
      return function (d) {
        return c.createElement.apply(c, [a, b].concat(d));
      };
    };
  }
...
(function (a) {
  ...
  var f = new function (a) {
    this.toElement = a;
  }((0, c.createElementImpl)(c.fragment)({}));

  b.component = function (a) {
    return c.componentImpl;
  };

  b.writeState = a;

  b.createLeafElement = function (a) {
    return c.createLeafElementImpl;
  };
  ...
  b.isReactElementArray = f;
  b.getState = c.getState;
  b.createElementTagName = c.createElementTagName;
  b.createElementTagNameDynamic = c.createElementTagNameDynamic;
})(PS);
...
(function (a) {
  ...
  var b = a["Concur.Core.Discharge"],
    ...
    var k = function k(a) {
      return m.toElement(m.isReactElementArray)(a.view);
        ...
        n = function n(a) {
      return function (k) {
        if (k instanceof c.Right) return function () {
          var c = b.discharge(e.monoidArray)(n(a))(k.value0)();
          return f["void"](l.functorEffect)(m.writeState(a)({
            view: c
          }))();
        };
        if (k instanceof c.Left) return function () {
          p.log("FAILED! " + d.show(h.showError)(k.value0))();
          return g.unit;
        };
        throw Error("Failed pattern match at Concur.React (line 31, column 3 - line 33, column 50): " + [a.constructor.name, k.constructor.name]);
      };
    };

    return m.component()("Concur")(function (d) {
      return function () {
        var g = b.dischargePartialEffect(e.monoidArray)(a)();
        return {
          state: {
            view: g.value1
          },
          render: f.map(l.functorEffect)(k)(m.getState(d)),
          componentDidMount: n(d)(new c.Right(g.value0))
        };
      };
    });
  };
  ...
  a["Concur.React"].renderComponent = function (a) {
    return m.createLeafElement()(q(a))({});
  };
})(PS);
...
(function (a) {
  ...
  a = c.unsafeMkProps("value");
  var e = c.unsafeMkProps("target");
  b.target = e;
  b.value = a;

  b.onChange = function (a) {
    return c.unsafeMkProps("onChange")(f.mkEffectFn1(a));
  };

  b.unsafeFromPropsArray = c.unsafeFromPropsArray;
})(PS);
...
(function (a) {
  ...
  var e = function e(a) {
    return function (b) {
      return function (d) {
        if (a) {
          if (a) var e = c.createElementTagNameDynamic;else throw Error("Failed pattern match at React.DOM (line 15, column 5 - line 17, column 55): " + [a.constructor.name]);
        } else e = c.createElementTagName;
        return e(b)(f.unsafeFromPropsArray(d));
      };
    };
  },
      d = e(!1)("div");
...
(function (a) {
  ...
  var b = a["Concur.React.DOM"],
    ...
    return function (b) {
      ...
      p = function p(a) {
    return function (b) {
      return c.elLeaf(a)(d.functorArray)(function (a) {
        return [b(a)];
      });
    };
  },
    ...
    return function (b) {
      return function (e) {
        return c["el'"](a)(b)(d.functorArray)(l(e));
      };
    };
  },
      m = function m(a) {
    return function (b) {
      return c.el(a)(d.functorArray)(l(b));
    };
  },
      q = function q(a) {
    return function (b) {
  ...
  b.text = function (a) {
    return function (b) {
      return f.liftWidget(a)(e.display([g.text(b)]));
    };
  };
...
(function (a) {
  ...
  a = new a["Concur.Core.Props"].Handler(a["React.DOM.Props"].onChange);
...
(function (a) {
  ...
  a.renderImpl = function (a, f) {
    return b.render(a, f);
  };
})(PS.ReactDOM = PS.ReactDOM || {});

(function (a) {
  a.nullable = function (a, c, f) {
    return null == a ? c : f(a);
  };
...
(function (a) {
  ...
  a["Data.Nullable"].toMaybe = function (a) {
    return b.nullable(a, c.Nothing.value, c.Just.create);
  };
})(PS);
...
(function (a) {
  ...
  a.ReactDOM.render = function (a) {
    return function (d) {
      return c.map(e.functorEffect)(f.toMaybe)(function () {
        return b.renderImpl(a, d);
      });
    };
  };
})(PS);
...
(function (a) {
  ...
  a["Web.DOM.NonElementParentNode"].getElementById = function (a) {
    var d = c.map(e.functorEffect)(f.toMaybe),
        l = b._getElementById(a);
  ...
  a["Concur.React.Run"].runWidgetInDom = function (a) {
    return function (q) {
      return function () {
        var k = p.window();
        k = m.document(k)();
        k = h.toNonElementParentNode(k);
        k = l.getElementById(a)(k)();
        if (k instanceof f.Nothing) return e.unit;
        if (k instanceof f.Just) return c["void"](d.functorEffect)(g.render(b.renderComponent(q))(k.value0))();
        throw Error("Failed pattern match at Concur.React.Run (line 23, column 3 - line 25, column 65): " + [k.constructor.name]);
      };
    };
  };
})(PS);
...
(function (a) {
  a["Data.Semigroup.First"] = a["Data.Semigroup.First"] || {};
  var b = a["Data.Semigroup.First"];
  a = new a["Data.Semigroup"].Semigroup(function (a) {
    return function (b) {
      return a;
    };
  });
...
(function (a) {
  ...
  var r = function () {
    var a = function a(b) {
      return c.step(b)(m.bind(d.widgetBind)(g.input(f.widgetLiftWidget)([t.map(e.functorProps)(l.unsafeTargetValue)(l.onChange)]))(function (b) {
        return h.pure(d.widgetApplicative)(a(new k.Just(b)));
      }));
    };

    return c.dyn(c.loopS(n.monoidArray)(k.Nothing.value)(function (b) {
      return g.div_(q.shiftMapCofree(n.monoidArray))([])(m.bind(q.bindCofree(d.widgetAlternative(n.monoidArray)))(a(k.Nothing.value))(function (a) {
        return m.bind(q.bindCofree(d.widgetAlternative(n.monoidArray)))(h.pure(q.applicativeCofree(d.widgetAlternative(n.monoidArray)))(u.unwrap(u.newtypeFirst)(x.append(v.semigroupFirst)(a)(b))))(function (a) {
          return m.discard(m.discardUnit)(q.bindCofree(d.widgetAlternative(n.monoidArray)))(c.display(g["div'"](d.widgetMultiAlternative(n.monoidArray))(d.widgetShiftMap)([g.text(f.widgetLiftWidget)("Old Name: " + B.show(k.showMaybe(B.showString))(b))])))(function () {
            return m.discard(m.discardUnit)(q.bindCofree(d.widgetAlternative(n.monoidArray)))(c.display(g["div'"](d.widgetMultiAlternative(n.monoidArray))(d.widgetShiftMap)([g.text(f.widgetLiftWidget)("New Name: " + B.show(k.showMaybe(B.showString))(a))])))(function () {
              return h.pure(q.applicativeCofree(d.widgetAlternative(n.monoidArray)))(a);
            });
          });
        });
      }));
  ...
  F = h.pure(a.applicativeEffect)(F.unit);
  b.main = F;
  b.testWidget = r;

  b.runFormSPA = function (a) {
    return p.runWidgetInDom(a)(r);
  };
})(PS);
...
//# sourceMappingURL=prod.e16852ab.js.map